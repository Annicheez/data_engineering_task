...
# Concactenate dataframes locally using pandas to ensure 0% data loss
...
# Converting pandas object types to string for safe injestion of non-sql supported dtypes
...
# Write master df to a table in the db
